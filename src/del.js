...
class Chess extends React.Component {
  ...
  checkking = (id) => {
    for (let o = 0; o <= 63; o++) {
      if (document.getElementsByClassName('icon')[o].style.border == '3px solid blue') {
        ...
        if (document.getElementById(ikd).style.border == '3px solid green') {
          document.getElementById(ikd).style.border = '';
  ...
  checkdanger = (id) => {
    ...
    for (var d = 0; d <= 63; d++) {
      if (document.getElementsByClassName('icon')[d].innerHTML == '♔' || document.getElementsByClassName('icon')[d].innerHTML == '♚') {
        if (this.arr.includes(document.getElementsByClassName('icon')[d].innerHTML)) {
          for (var o = 0; o <= 63; o++) {
            if (document.getElementsByClassName('icon')[o].style.border == '3px solid blue' || document.getElementsByClassName('icon')[o].style.border == '3px solid red') {
              ...
              document.getElementById(id).innerHTML = '';
              this.check();
              if (document.getElementsByClassName('icon')[d].style.border == '3px solid green') {
                console.log('called');
                document.getElementById(ikd).style.border = '';
                document.getElementById(id).innerHTML = document.getElementById(ikd).innerHTML;
    ...
    for (let i = 1; i <= 63; i++) {
      if (this.arr.includes(document.getElementsByClassName('icon')[i].innerHTML)) {
        if ((document.getElementsByClassName('icon')[i].innerHTML == '♔' || document.getElementsByClassName('icon')[i].innerHTML == '♚') && document.getElementsByClassName('icon')[i].style.border == '3px solid green')
          document.getElementsByClassName('icon')[i].style.border = '';
        // console.log('yes');
      }
    }
  }
  ...
  king_bishop = (pawn_id) => {
    ...
    if (this.z == 0) {
      for (let i = 0; i <= 63; i++) {
        if ((document.getElementsByClassName('icon')[i].innerHTML == this.kig) && document.getElementsByClassName('icon')[i].style.border == '3px solid green') {
          document.getElementsByClassName('icon')[i].style.border = '';
        }
      }
    }
  ...
  king_knight = (pawn_id) => {
    ...
    if (document.getElementById(new_id13) != undefined && this.arr2.includes(document.getElementById(new_id13).innerHTML) != true) {
      if ((document.getElementById(new_id13).innerHTML == this.kig)) {
        document.getElementById(new_id13).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id14) != undefined && this.arr2.includes(document.getElementById(new_id14).innerHTML) != true) {
      if ((document.getElementById(new_id14).innerHTML == this.kig)) {
        document.getElementById(new_id14).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id23) != undefined && this.arr2.includes(document.getElementById(new_id23).innerHTML) != true) {
      if ((document.getElementById(new_id23).innerHTML == this.kig)) {
        document.getElementById(new_id23).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id24) != undefined && this.arr2.includes(document.getElementById(new_id24).innerHTML) != true) {
      if ((document.getElementById(new_id24).innerHTML == this.kig)) {
        document.getElementById(new_id24).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id33) != undefined && this.arr2.includes(document.getElementById(new_id33).innerHTML) != true) {
      if ((document.getElementById(new_id33).innerHTML == this.kig)) {
        document.getElementById(new_id33).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id34) != undefined && this.arr2.includes(document.getElementById(new_id34).innerHTML) != true) {
      if ((document.getElementById(new_id34).innerHTML == this.kig)) {
        document.getElementById(new_id34).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id43) != undefined && this.arr2.includes(document.getElementById(new_id43).innerHTML) != true) {
      if ((document.getElementById(new_id43).innerHTML == this.kig)) {
        document.getElementById(new_id43).style.border = '3px solid green';
        this.z++;
      }
    }
    if (document.getElementById(new_id44) != undefined && this.arr2.includes(document.getElementById(new_id44).innerHTML) != true) {
      if ((document.getElementById(new_id44).innerHTML == this.kig)) {
        document.getElementById(new_id44).style.border = '3px solid green';
        this.z++;
      }
    }
    if (this.z == 0) {
  ...
  king_white_pawn = (pawn_id) => {
    ...
    if (this.z == 0) {
      for (let i = 0; i <= 63; i++) {
        if (this.arr.includes(document.getElementsByClassName('icon')[i].innerHTML) == false && (document.getElementsByClassName('icon')[i].innerHTML == '♚' || document.getElementsByClassName('icon')[i].innerHTML == '♔') && document.getElementsByClassName('icon')[i].style.border == '3px solid green') {
          document.getElementsByClassName('icon')[i].style.border = '';
        }
      }
    }
  ...
  mate = (pawn_id) => {
    ...
    if (document.getElementById(new_id).style.border = '3px solid green') {
      let gh1 = 0;
      let gh2 = 0;
      // let gh9=0;
      if (document.getElementById(new_id11) != undefined && this.arr.includes(document.getElementById(new_id11).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id11).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id11).style.border = '';
      ...
      if (document.getElementById(new_id12) != undefined && this.arr.includes(document.getElementById(new_id12).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id12).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id12).style.border = '';
      ...
      if (document.getElementById(new_id21) != undefined && this.arr.includes(document.getElementById(new_id21).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id21).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id21).style.border = '';
      ...
      if (document.getElementById(new_id22) != undefined && this.arr.includes(document.getElementById(new_id22).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id22).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id22).style.border = '';
      ...
      if (document.getElementById(new_id13) != undefined && this.arr.includes(document.getElementById(new_id13).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id13).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id13).style.border = '';
      ...
      if (document.getElementById(new_id14) != undefined && this.arr.includes(document.getElementById(new_id14).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id14).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id14).style.border = '';
      ...
      if (document.getElementById(new_id23) != undefined && this.arr.includes(document.getElementById(new_id23).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id23).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id23).style.border = '';
      ...
      if (document.getElementById(new_id24) != undefined && this.arr.includes(document.getElementById(new_id24).innerHTML) == false) {
        ...
        //   gh2++
        // }
        if (document.getElementById(new_id24).style.border == '3px solid green') {
          gh2++;
        }
        document.getElementById(new_id24).style.border = '';
        document.getElementById(new_id24).innerHTML = u;
      }
      let ghy = 0;
      // console.log(gh1, gh2);
      for (let i = 0; i <= 63; i++) {
        if (document.getElementsByClassName('icon')[i].style.border == '3px solid red' || document.getElementsByClassName('icon')[i].style.border == '3px solid blue') {
          ghy++;
          document.getElementsByClassName('icon')[i].style.border = '';
        }
      }
  ...
  king = (pawn_id) => {
    ...
    // document.getElementById(new_id).style.border = '3px solid blue';

    if (document.getElementById(new_id11) != undefined && this.arr.includes(document.getElementById(new_id11).innerHTML) == false) {
      document.getElementById(new_id11).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id12) != undefined && this.arr.includes(document.getElementById(new_id12).innerHTML) == false) {
      document.getElementById(new_id12).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id21) != undefined && this.arr.includes(document.getElementById(new_id21).innerHTML) == false) {
      document.getElementById(new_id21).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id22) != undefined && this.arr.includes(document.getElementById(new_id22).innerHTML) == false) {
      document.getElementById(new_id22).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id13) != undefined && this.arr.includes(document.getElementById(new_id13).innerHTML) == false) {
      document.getElementById(new_id13).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id14) != undefined && this.arr.includes(document.getElementById(new_id14).innerHTML) == false) {
      document.getElementById(new_id14).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id23) != undefined && this.arr.includes(document.getElementById(new_id23).innerHTML) == false) {
      document.getElementById(new_id23).style.border = '3px solid blue';
    }
    if (document.getElementById(new_id24) != undefined && this.arr.includes(document.getElementById(new_id24).innerHTML) == false) {
      document.getElementById(new_id24).style.border = '3px solid blue';
    }
    this.checkking(pawn_id);
    for (let i = 0; i <= 63; i++) {
      if (document.getElementsByClassName('icon')[i].style.border == "3px solid blue" && document.getElementsByClassName('icon')[i].innerHTML != '' && this.arr.includes(document.getElementsByClassName('icon')[i].innerHTML) == false)
        document.getElementsByClassName('icon')[i].style.border = "3px solid red";
    }
  ...
  bishop = (pawn_id) => {
    ...
    for (let i = 0; i <= 63; i++) {
      if (document.getElementsByClassName('icon')[i].style.border == "3px solid blue" && this.arr.includes(document.getElementsByClassName('icon')[i].innerHTML) == false && document.getElementsByClassName('icon')[i].innerHTML != '')
        document.getElementsByClassName('icon')[i].style.border = "3px solid red";
    }
  ...
  white_pawn = (pawn_id) => {
    ...
    if (document.getElementById(pawn_id).parentElement.id == 'row2') {
      ...
      // document.getElementById(`r${new_id[1]}icon${new_id[6]}`).style.border = '3px solid blue';
      document.getElementById(new_id1).innerHTML != '' ? console.log('') : document.getElementById(new_id1).style.border = '3px solid blue';

      if (document.getElementById(new_id1).innerHTML == '') {
        document.getElementById(new_id2).innerHTML != '' ? console.log('') : document.getElementById(new_id2).style.border = '3px solid blue';
      }
      if (parseInt(new_id[6]) < 8) {
        this.sarr_black.includes(document.getElementById(new_id11).innerHTML) ? document.getElementById(new_id11).style.border = '3px solid blue' : console.log();
      }
      if (parseInt(new_id[6]) > 1) {
        this.sarr_black.includes(document.getElementById(new_id12).innerHTML) ? document.getElementById(new_id12).style.border = '3px solid blue' : console.log();
      }
  ...
  black_pawn = (pawn_id) => {
    ...
    if (document.getElementById(pawn_id).parentElement.id == 'row7') {
      ...
      if (parseInt(new_id[6]) < 8) {
        this.sarr_white.includes(document.getElementById(new_id11).innerHTML) ? document.getElementById(new_id11).style.border = '3px solid blue' : console.log();
      }
      if (parseInt(new_id[6]) > 1) {
        this.sarr_white.includes(document.getElementById(new_id12).innerHTML) ? document.getElementById(new_id12).style.border = '3px solid blue' : console.log();
      }
  ...
  knight = (pawn_id) => {
    ...
    // document.getElementById(pawn_id).style.border = '3px solid blue';
    ...
    for (let i = 0; i <= 63; i++) {
      ...
      if (document.getElementsByClassName('icon')[i].innerHTML == '♔' || document.getElementsByClassName('icon')[i].innerHTML == '♚') {
        ...
        if (this.arr.includes(document.getElementsByClassName('icon')[i].innerHTML)) {
          ...
          if (document.getElementsByClassName('icon')[i].style.border == '3px solid green') {
            // console.log('pass3')
            ...
            for (let o = 0; o <= 63; o++) {
              ...
              if (document.getElementsByClassName('icon')[o].style.border == '3px solid blue') {
                ...
                if (document.getElementsByClassName('icon')[i].style.border == '') {
                  console.log('my name is dhaval');
                  document.getElementById(id).innerHTML = document.getElementById(ikd).innerHTML;
                  document.getElementById(ikd).innerHTML = '';
                }
                else if (document.getElementsByClassName('icon')[i].style.border == '3px solid green') {
                  document.getElementById(ikd).style.border = '';
                  document.getElementById(id).innerHTML = document.getElementById(ikd).innerHTML;
                  document.getElementById(ikd).innerHTML = '';
                }
              ...
              else if (document.getElementsByClassName('icon')[o].style.border == '3px solid red') {
  ...
  clk = (e) => {
    ...
    if (arr_black.includes(bd) && this.index == 0) {
      // for (let i = 0; i <= 63; i++) {
      //   document.getElementsByClassName('icon1')[i].innerHTML = document.getElementsByClassName('icon')[i].innerHTML;
      // }
      this.arr = arr_black;
    }
    ...
    if (bd != '' && this.index == 0) {
      ...
      if (this.turn == 'black' && arr_black.includes(goti) || this.turn == 'white' && arr_white.includes(goti)) {
        for (i = 0; i <= 63; i++) {
          ...
          document.getElementsByClassName('icon')[i].style.border = "none";
        }
      }
      ...
      if (this.turn == 'white' && arr_white.includes(goti)) {
        ...
        for (i = 0; i <= 63; i++) {
          if (document.getElementsByClassName('icon')[i].style.border == "3px solid blue" && this.sarr_black.includes(document.getElementsByClassName('icon')[i].innerHTML) == true)
            document.getElementsByClassName('icon')[i].style.border = "3px solid red";
        }
        ...
        for (i = 0; i <= 63; i++) {
          if (document.getElementsByClassName('icon')[i].style.border == "3px solid blue" && this.sarr_white.includes(document.getElementsByClassName('icon')[i].innerHTML) == true)
            document.getElementsByClassName('icon')[i].style.border = "3px solid red";
        }
      ...
      if (this.arr.includes(bd) != true) {
        ...
        if ((this.idd || this.goticode) != '' && (document.getElementById(e.target.id).style.border == '3px solid blue' || document.getElementById(e.target.id).style.border == '3px solid red')) {
    ...
    else if (bd == ''&& (document.getElementById(e.target.id).style.border == '3px solid blue' || document.getElementById(e.target.id).style.border == '3px solid red')) {
  ...
  //   // console.log("baack");
  //   for (let i = 0; i <= 63; i++) {
  //     document.getElementsByClassName('icon')[i].innerHTML = document.getElementsByClassName('icon1')[i].innerHTML;
  //   }
  ...
  render() {
    return (<>
      <div className="App" id='new'>
        <button disabled={this.dis} id='back' onClick={this.back}>back</button>
        <div id="chess">
      ...
      {/* <div id='x'>
        <div id="row1" className="row">
          <div className="icon1 black" id="s1" onClick={this.clk}>&#9814;</div>
          <div className="icon1 white" id="s2" onClick={this.clk}>&#9816;</div>
          <div className="icon1 black" id="s3" onClick={this.clk}>&#9815;</div>
          <div className="icon1 white" id="s4" onClick={this.clk}>&#9813;</div>
          <div className="icon1 black" id="s5" onClick={this.clk}>&#9812;</div>
          <div className="icon1 white" id="s6" onClick={this.clk}>&#9815;</div>
          <div className="icon1 black" id="s7" onClick={this.clk}>&#9816;</div>
          <div className="icon1 white" id="s8" onClick={this.clk}>&#9814;</div>
        </div>

        <div id="row2" className="row">
          <div className="icon1 white" id="s9" onClick={this.clk}>&#9817;</div>
          <div className="icon1 black" id="s10" onClick={this.clk}>&#9817;</div>
          <div className="icon1 white" id="s11" onClick={this.clk}>&#9817;</div>
          <div className="icon1 black" id="s12" onClick={this.clk}>&#9817;</div>
          <div className="icon1 white" id="s13" onClick={this.clk}>&#9817;</div>
          <div className="icon1 black" id="s14" onClick={this.clk}>&#9817;</div>
          <div className="icon1 white" id="s15" onClick={this.clk}>&#9817;</div>
          <div className="icon1 black" id="s16" onClick={this.clk}>&#9817;</div>
        </div>
        <div id="row3naclassName" className="row">
          <div className="icon1 black" id="s17" onClick={this.clk}></div>
          <div className="icon1 white" id="s18" onClick={this.clk}></div>
          <div className="icon1 black" id="s19" onClick={this.clk}></div>
          <div className="icon1 white" id="s20" onClick={this.clk}></div>
          <div className="icon1 black" id="s21" onClick={this.clk}></div>
          <div className="icon1 white" id="s22" onClick={this.clk}></div>
          <div className="icon1 black" id="s23" onClick={this.clk}></div>
          <div className="icon1 white" id="s24" onClick={this.clk}></div>
        </div>

        <div id="row4" className="row">
          <div className="icon1 white" id="s25" onClick={this.clk}></div>
          <div className="icon1 black" id="s26" onClick={this.clk}></div>
          <div className="icon1 white" id="s27" onClick={this.clk}></div>
          <div className="icon1 black" id="s28" onClick={this.clk}></div>
          <div className="icon1 white" id="s29" onClick={this.clk}></div>
          <div className="icon1 black" id="s30" onClick={this.clk}></div>
          <div className="icon1 white" id="s31" onClick={this.clk}></div>
          <div className="icon1 black" id="s32" onClick={this.clk}></div>
        </div>

        <div id="row5" className="row">
          <div className="icon1 black" id="s33" onClick={this.clk}></div>
          <div className="icon1 white" id="s34" onClick={this.clk}></div>
          <div className="icon1 black" id="s35" onClick={this.clk}></div>
          <div className="icon1 white" id="s36" onClick={this.clk}></div>
          <div className="icon1 black" id="s37" onClick={this.clk}></div>
          <div className="icon1 white" id="s38" onClick={this.clk}></div>
          <div className="icon1 black" id="s39" onClick={this.clk}></div>
          <div className="icon1 white" id="s40" onClick={this.clk}></div>
        </div>

        <div id="row6" className="row">
          <div className="icon1 white" id="s41" onClick={this.clk}></div>
          <div className="icon1 black" id="s42" onClick={this.clk}></div>
          <div className="icon1 white" id="s43" onClick={this.clk}></div>
          <div className="icon1 black" id="s44" onClick={this.clk}></div>
          <div className="icon1 white" id="s45" onClick={this.clk}></div>
          <div className="icon1 black" id="s46" onClick={this.clk}></div>
          <div className="icon1 white" id="s47" onClick={this.clk}></div>
          <div className="icon1 black" id="s48" onClick={this.clk}></div>
        </div>

        <div id="row7" className="row">
          <div className="icon1 black" id="s49" onClick={this.clk}>&#9823;</div>
          <div className="icon1 white" id="s50" onClick={this.clk}>&#9823;</div>
          <div className="icon1 black" id="s51" onClick={this.clk}>&#9823;</div>
          <div className="icon1 white" id="s52" onClick={this.clk}>&#9823;</div>
          <div className="icon1 black" id="s53" onClick={this.clk}>&#9823;</div>
          <div className="icon1 white" id="s54" onClick={this.clk}>&#9823;</div>
          <div className="icon1 black" id="s55" onClick={this.clk}>&#9823;</div>
          <div className="icon1 white" id="s56" onClick={this.clk}>&#9823;</div>
        </div>

        <div id="row8" className="row">
          <div className="icon1 white" id="s57" onClick={this.clk}>&#9820;</div>
          <div className="icon1 black" id="s58" onClick={this.clk}>&#9822;</div>
          <div className="icon1 white" id="s59" onClick={this.clk}>&#9821;</div>
          <div className="icon1 black" id="s60" onClick={this.clk}>&#9818;</div>
          <div className="icon1 white" id="s61" onClick={this.clk}>&#9819;</div>
          <div className="icon1 black" id="s62" onClick={this.clk}>&#9821;</div>
          <div className="icon1 white" id="s63" onClick={this.clk}>&#9822;</div>
          <div className="icon1 black" id="s64" onClick={this.clk}>&#9820;</div>
        </div>
      </div> */}
